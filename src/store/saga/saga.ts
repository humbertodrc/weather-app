...
function* getWeather(action: GetWeatherAction): Generator<CallEffect<unknown> | PutEffect, void, unknown> {
  try {
...
function* getPronosticoSaga(action: GetWeatherAction): Generator<CallEffect<unknown> | PutEffect, void, unknown> {
  try {
